/*
	Source: 		Column CE in Gradebook
	Author: 		Mohamad Mahdi Ziaee
	Description:	Store images in GCS for three different users where the object name on GCS is in the format <username>/<object-name>.jpg.
					Using the webpage from the previous example,
					display the images for each user on the webpage. The code linked here will help.
*/
